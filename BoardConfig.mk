...
BOARD_MKBOOTIMG_ARGS += --header_version $(BOARD_BOOT_HEADER_VERSION) --pagesize $(BOARD_KERNEL_PAGESIZE) --board "SRPTE20A003RU"
BOARD_MKBOOTIMG_ARGS += --dtb $(TARGET_PREBUILT_DTB) --dtb_offset $(BOARD_DTB_OFFSET)
BOARD_CUSTOM_BOOTIMG_MK := device/samsung/m31s/bootimg.mk
...
BOARD_SAMSUNG_DYNAMIC_PARTITIONS_SIZE := 8006926336
...
BOARD_AVB_MAKE_VBMETA_IMAGE_ARGS += --flag 22
